...
def _add_covariance_ellipse(
    ...
    *,
    ...
    # Matplotlib rejects dashed patch styles when the stroke width is zero,
    # which is how these filled-only ellipses are intentionally rendered.
    effective_linestyle = "-" if linewidth <= 0.0 else linestyle
    ellipse = Ellipse(
