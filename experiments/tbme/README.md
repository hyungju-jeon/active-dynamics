...
- `exp06_bottleneck.py`: gated-Duffing bottleneck experiments.
...
| --- | --- |
| `simple_system_identification` | `exp01_baseEnv.py` |
| `observation_action_bottleneck` | `exp06_bottleneck.py` |
| `model_mismatch` | `exp04_mismatch.py`, `exp08_parameter_mismatch_stress.py`, `exp09_observation_tuning_mismatch.py` |
| `objective_ablation` | `exp05_ablation.py` |
| `scheduling` | `exp03_schedule.py` |
