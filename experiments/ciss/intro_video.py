...
from actdyn.utils.ciss_video import animate_latent_and_spikes, animate_latent_trajectory, animate_spikes
...
if __name__ == "__main__":
    ...
    base_dir = ensure_dir(os.path.join(os.path.dirname(__file__), "../../results", "CISS"))
    ...
    for exp_id in exp_name:
        base_dir = ensure_dir(os.path.join(os.path.dirname(__file__), "../../results", "CISS", exp_id))
        ...
        for i in range(1):
            ...
            experiment.init_experiment(reset=True)
